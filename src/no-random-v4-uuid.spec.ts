...
createTester().run(ruleId, rule, {
  ...
  invalid: [
    ...
    {
      name: 'Invalid case with standard JS crypto.randomUUID',
    ...
    {
      name: 'Invalid case with standard JS crypto.randomUUID in a function',
    ...
    {
      name: 'Invalid case with standard JS crypto.randomUUID in an object method',
      code: `const obj = {
           generateUUID() {
             return crypto.randomUUID();
           }
         };
         const id = obj.generateUUID();`,
      errors: [
        {
          messageId: 'NO_RANDOM_V4_UUID',
        },
    ...
    {
      name: 'Invalid case with standard JS crypto.randomUUID in a class method',
      code: `class UUIDGenerator {
           generate() {
             return crypto.randomUUID();
           }
         }
    ...
    {
      name: 'Invalid case with standard JS crypto.randomUUID in an arrow function',
      code: `const generateUUID = () => crypto.randomUUID();
         const id = generateUUID();`,
      errors: [
        {
          messageId: 'NO_RANDOM_V4_UUID',
    ...
    {
      name: 'Invalid case with standard JS crypto.randomUUID in a nested function',
      code: `function outer() {
           function inner() {
             return crypto.randomUUID();
           }
