with
  ...
  FinancialData AS (
    ...
    FROM
      ...
      LEFT OUTER JOIN "teampay-approval" AS tar ON tar.partition_date >= '2021/01/01'
      AND json_extract_scalar(tar.requestbody, '$.matchedMessageId') = json_extract_scalar(ta.requestbody, '$.messageId')
    WHERE
      ...
      AND upc.Bin = p.p_bin - -
      and ta.partition_date >= '2025/06/01' -- and ta.partition_date < '2025/07/01'
      and ta.partition_date >= '2021/01/01'
  ),
  ...
  created_card_ids AS (
    ...
    WHERE
      ...
      and tcm.partition_date >= '2025/06/01'
      and tcm.partition_date < '2025/07/01'
  ),
  ...
  prior_card_ids AS (
    ...
    WHERE
      ...
      and tcm.partition_date >= '2021/01/01'
  ),
  ...
  cardManagementData AS (
    ...
    WHERE
      ...
      and tcm.partition_date >= '2021/01/01'
      and tcmch.partition_date >= '2021/01/01'
  ),
  ...
  cardApprovalData AS (
    ...
    WHERE
      ...
      and ta.partition_date >= '2025/06/01' -- and ta.partition_date < '2025/07/01'
      and ta.partition_date >= '2021/01/01'
      and matched_ta.partition_date >= '2021/01/01'
  ),
